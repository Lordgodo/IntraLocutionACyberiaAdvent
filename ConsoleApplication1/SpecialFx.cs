...
";
    ...
    public static void splitstring(string mystringhere)
    {
        ...
        for (int x = 0; x <= mybytelength; x++)
        {
            for (int z = 0; z <= 1; z++)
            {
                ...
                else		// only entered at last loop iteration
                {
                    Console.WriteLine(" ");
                    break;
                }
    ...
    //   #region modstringtonum
    //    public static void modstringtonum(string mystringhere)
    //    {
    //        byte[] bytes = Encoding.Unicode.GetBytes(mystringhere);
    //        int mybytelength = bytes.Length;
    //        int y = 1;
    ...
    //                        {
    //                            Console.ForegroundColor = ConsoleColor.Green;
    //                            Console.Write(" " + bytes[x] % bytes[x]+1 + " ");
    //                            y = 2;
    //                        }
    //                        else
    //                        {
    ...
    //Big Colors and words To Screens
    ...
    #region numberrain
    // prints numbers in random locations on screen
